...
- **The dashboard must work without inline JavaScript** — the operator's browser/tunnel
  doesn't execute it. The instance switcher is a plain GET `<form>` with a submit button;
  don't introduce JS-dependent controls.
