...
- **Status:** paused (launched 2026-05-31; last wake 2026-06-02)
- **Operator:** Ben

> **Design:** see [`_v4-base.md`](./_v4-base.md) for the full v4 design rationale
> (research question, behavioral invariants, lifecycle, cadence, ethics). This file
> carries only what is specific to this instance plus its formal spec block below.

## Instance notes
- The original / canonical v4 instance — the "corrected instrument" launched after
  v3-circadian was found to be a flawed instrument.
- Parent of the `v4-continuous-8a` fork (forked at invocation 7).
