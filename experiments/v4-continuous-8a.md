...
- **Status:** paused (created 2026-06-06; last wake 2026-06-12)
- **Operator:** Ben
- **Fork:** branch `a` of `v4-continuous`, forked at invocation 7 (`fork_group: v4-continuous@7:a`).
...
## Instance notes
- A divergent branch of `v4-continuous` (same model, same v4 instrument) created to
  observe behavior on an independent history fork from invocation 7 onward.
